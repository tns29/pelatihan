...
<section class="content">
    <div class="container-fluid">
        <div class="card w-75 mx-3 elevation-1 p-3">
            <form action="/update-participant-work/{{$resultData->participant_number}}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                                ...
                                <select class="select-participant form-control" name="participant_number" id="participant_number" class="@error('participant_number')is-invalid @enderror" disabled>
                                    <option value="">Pilih Peserta</option>
                                    @foreach ($participantData as $item)
                                        <option value="{{ $item->participant_number }}" {{ $resultData->participant_number == $item->participant_number ? 'selected' : '' }}>
                            ...
                            <?php 
                            $month = explode('-', $resultData->date_year);
                            $month_fix = $month[1].'-'.$month[0].'-01';
                            ?>
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                <label for="date_year">Bulan - Tahun  </label>
                                <input type="month" class="form-control @error('date_year') is-invalid @enderror" name="date_year" id="date_year" value="{{ old('date_year', date('Y-m', strtotime($month_fix)) ) }}" pattern="[0-9]{4}-[0-9]{2}">
                                @error('date_year')
                                <small class="invalid-feedback">
                                    Bulan - Tahun {{ $message }}
                                </small>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="text" class="form-control @error('company_name')is-invalid @enderror" name="company_name" id="company_name" value="{{ old('company_name', $resultData->company_name) }}">
                                @error('company_name')
                                <small class="invalid-feedback">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="position" class="form-control @error('position')is-invalid @enderror" name="position" id="position" value="{{ old('position', $resultData->position) }}">
                                @error('position')
                                <small class="invalid-feedback">
