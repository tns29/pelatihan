                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                                ...
                                <select name="participant_number" id="participant_number" class="form-control form-select @error('participant_number')is-invalid @enderror" disabled>
                                    <option value="">Pilih Peserta</option>
                                    @foreach ($participantData as $item)
                                        <option value="{{ $item->number }}" {{ $resultData->participant_number == $item->number ? 'selected' : '' }}>
